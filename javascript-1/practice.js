...
let me = {
	...
	state: 'Utah'
	age: 27
	greeter: 'Hello! My name is and I live in '
}
...
let doubled = myNumbers.map(myNumbers => myNumbers * 2); 
...
let filtered = myNumbers.filter(myNumbers => (myNumbers > 100))

//////////////////PROBLEM 16////////////////////

// Next up, reduce to get the total of the array. call the new array 'total'

let total = myNumbers.reduce((total, myNumbers) => total + myNumbers, 0)
...
let enemies = people.filter(people => (people === false))
...
// Code Here
let totallyAwesome = people.reduce((total, awesomeLevel) => total + awesomeLevel, 0)
